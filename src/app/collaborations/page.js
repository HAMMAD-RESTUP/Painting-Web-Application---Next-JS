...
export default function CollaborationsPage() {
  useEffect(() => {
    document.title = "Collaborations | Rakhshinda Art";

    const description =
      "Explore Rakhshinda Art collaborations with Funun Arts Group, The Dubai Workshop, and Kutubna Cultural Center in Dubai, UAE.";
    ...
    keywords.content =
      "Rakhshinda Art collaborations, Funun Arts Group, The Dubai Workshop, Kutubna Cultural Center, Dubai art, UAE artist, art workshop, art exhibition, cultural collaboration";
  }, []);
        ...
        <section className="relative overflow-hidden border-b border-[#e8e2d7] px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="relative z-10 mx-auto max-w-[1240px] text-center">
            ...
            <motion.h1
              ...
              className={`${cormorant.className} mx-auto mt-6 max-w-5xl text-[58px] font-normal italic leading-[0.9] tracking-[-0.055em] text-[#191714] sm:text-[78px] lg:text-[104px]`}
            >
              Trusted
              ...
              return (
                ...
                >
                  ...
                  <div className="rounded-[34px] border border-[#e8e2d7] bg-white/65 p-7 shadow-[0_18px_55px_rgba(45,35,24,0.05)] backdrop-blur-md sm:p-9 lg:p-10">
                    ...
                    <h2
                      className={`${cormorant.className} mt-4 text-[48px] font-normal italic leading-[0.92] tracking-[-0.045em] text-[#191714] sm:text-[62px] lg:text-[72px]`}
                    >
                      {item.title}
                    </h2>
          ...
          <div className="mx-auto max-w-[1240px] overflow-hidden rounded-[36px] border border-[#e8e2d7] bg-[#211e1a] p-8 text-white shadow-[0_28px_80px_rgba(45,35,24,0.16)] sm:p-10 lg:p-12">
            <div className="grid gap-7 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2
                  className={`${cormorant.className} mt-4 max-w-3xl text-[44px] font-normal italic leading-[0.95] tracking-[-0.04em] sm:text-[62px]`}
                >
