...
const galleryImages = [
  { title: "Soft Floral Study", image: "/images/inspiration-artist.jpg", href: "/collections" },
  { title: "Arabic Calligraphy", image: "/images/calligraphy-bg.png", href: "/collections" },
  { title: "Original Painting", image: "/images/original-paintings.jpg", href: "/collections" },
  { title: "Pattern Memory", image: "/images/islamic-geometry.jpg", href: "/collections" },
  { title: "Quiet Bloom", image: "/images/hero-1.jpg", href: "/collections" },
  { title: "Window Light", image: "/images/inspiration-window.jpg", href: "/collections" },
  { title: "Fine Lines", image: "/images/product1.jpg", href: "/collections" },
  { title: "Colourful Prints", image: "/images/prints.jpg", href: "/collections" },
];

const featuredPainting = { title: "A World Shaped by Colour", image: "/images/hero-3.jpg", href: "/collections" };
    ...
    <section id="gallery" className="relative overflow-hidden bg-gradient-to-b from-[#fdf8f2] to-[#f7f4ee] py-16 text-[#1e1e1c] sm:py-20 lg:py-24">
      ...
      <div className="mx-auto max-w-[1240px] px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.h2
          ...
          className={`${cormorant.className} text-[48px] font-normal italic leading-[0.88] tracking-[-0.055em] text-[#171512] sm:text-[68px] md:text-[82px] lg:text-[94px]`}
        >
          Art in every
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-4 right-4 p-4 sm:p-6">
        ...
        <h3 className={`${cormorant.className} text-[32px] font-normal italic leading-[0.9] text-white sm:text-[48px] lg:text-[56px]`}>
          {artwork.title}
        </h3>
