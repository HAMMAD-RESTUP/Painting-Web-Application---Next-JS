    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1280px]">
        ...
        >
          ...
          <h2
            className={`font-special text-[42px] font-normal italic leading-[0.92] tracking-[-0.055em] text-[#171717] xs:text-[46px] sm:text-[62px] md:text-[76px] lg:text-[92px]`}
          >
            Recent Artworks
                ...
                >
                  ...
                  >
                    ...
                    <div className="px-1 pt-4 text-left sm:pt-5">
                      ...
                      <h3
                        className={`font-special text-[26px] font-normal italic leading-none tracking-[-0.035em] text-[#1e1e1c] sm:text-[30px] md:text-[32px]`}
                      >
                        {art.title}
                      </h3>
                    </div>
        ...
        {preview && preview.x && !isDragging && (
          ...
          >
            <div className="overflow-hidden rounded-[18px] bg-white p-2 shadow-[0_24px_70px_rgba(0,0,0,0.18)]">
              ...
              />
              <p
                className={`font-special mt-2 px-2 text-[22px] font-normal italic text-[#1e1e1c]`}
              >
                {preview.title}
              </p>
            </div>
