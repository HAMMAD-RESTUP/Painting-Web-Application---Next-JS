          ...
          <AnimatePresence mode="wait">
            {submitted ? (
              ...
              >
                ...
                <h2
                  className={`${cormorant.className} text-[38px] font-normal italic text-[#1b1814] sm:text-[52px]`}
                >
                  You&apos;re on the list
                </h2>
              ...
              <motion.div key="form" exit={{ opacity: 0 }}>
                <h2
                  className={`${cormorant.className} mx-auto max-w-[800px] text-[45px] font-normal italic leading-[0.9] tracking-[-0.055em] text-[#1b1814] sm:text-[62px] lg:text-[76px]`}
                >
