    ...
    <main className="relative min-h-screen w-full overflow-hidden bg-[#f7f4ef] text-[#1e1e1c]">
      ...
      <div className="relative z-10 mx-auto max-w-[940px] px-4 py-24 sm:px-6 sm:py-32">
        ...
        <div className="text-center mb-20">
          ...
          <h1 className={`${cormorant.className} text-[48px] font-normal italic leading-[1.1] tracking-[-0.03em] text-[#191714] sm:text-[68px] md:text-[80px]`}>
            <div className="block">
        ...
        >
          ...
          <h4 className={`${cormorant.className} text-[26px] font-normal italic text-[#191714]`}>
